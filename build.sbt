...
libraryDependencies ++= Seq(
  "dev.zio" %% "zio" % "1.0.5" cross CrossVersion.for3Use2_13,
  "dev.zio" %% "zio-test" % "1.0.5" cross CrossVersion.for3Use2_13,
  "dev.zio" %% "zio-test-junit" % "1.0.5" cross CrossVersion.for3Use2_13,
  "dev.zio" %% "zio-logging" % "0.5.8" cross CrossVersion.for3Use2_13,
  "dev.zio" %% "zio-config" % "1.0.2" cross CrossVersion.for3Use2_13,
  "dev.zio" %% "zio-config-magnolia" % "1.0.2" cross CrossVersion.for3Use2_13,
  "dev.zio" %% "zio-config-typesafe" % "1.0.2" cross CrossVersion.for3Use2_13,
  "dev.zio" %% "zio-json" % "0.1.4" cross CrossVersion.for3Use2_13,
  "dev.zio" %% "zio-nio" % "1.0.0-RC10" cross CrossVersion.for3Use2_13,

  "com.softwaremill.sttp.client" %% "core" % versions.sttp cross CrossVersion.for3Use2_13,
  "com.softwaremill.sttp.client" %% "json4s" % versions.sttp cross CrossVersion.for3Use2_13,
  "com.softwaremill.sttp.client" %% "okhttp-backend" % versions.sttp cross CrossVersion.for3Use2_13,
